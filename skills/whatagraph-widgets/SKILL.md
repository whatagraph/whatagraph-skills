...
| Dynamic chart (scatter, bubble, heatmap, candlestick, box plot, radar, funnel, stacked and 100% stacked, horizontal bars, combo, top-N) | `142` — needs a `chart_spec`; load the `whatagraph-dynamic-charts` skill |
