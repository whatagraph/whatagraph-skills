...
| [generating-report-digests](skills/generating-report-digests/) | Summarize an existing Whatagraph report from a report URL, including comparison metrics and per-widget structured data |
